    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <p className="mb-4 text-sm text-slate-500">
          {isPerformance ? (
            <>
              팀만 지정하고 담당자를 비워두면 팀 전체에게 보이는 팀목표가
              되며, 그 팀의 팀장만 실제로 평가받습니다(팀원에게는 읽기
              전용으로 표시). 팀과 담당자(개인)를 함께 지정하면 팀원
              전체에게 목표는 보이되 그 담당자 본인만 평가받는 개인목표가
              됩니다. 팀 없이 담당자만 지정하면 그 사람에게만 보이고
              평가됩니다.
            </>
          ) : (
            <>
