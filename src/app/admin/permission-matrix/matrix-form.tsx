  ...
  return (
    <form action={formAction}>
      ...
      <p className="mb-3 rounded border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-800">
        <strong>인사카드 상세는 직책별 상한이 따로 있습니다.</strong> 이 표에서 더 넓게
        잡아도 사장=전사, 운영책임=본인 사업단위, 책임=본인 부문, 팀장=본인 팀,
        담당=본인 정보까지만 열립니다. 이 표는 상한을 <strong>좁히는</strong> 데만
        쓸 수 있습니다.
        <br />
        특정 임원에게 더 넓은 열람을 열어주려면 아래{" "}
        <strong>사용자별</strong> 탭에서 그 사람을 콕 집어 지정하세요. 개별 설정은
        상한을 넘어설 수 있습니다 — 역할을 관리자로 올릴 필요가 없습니다(관리자로
        올리면 개발 중인 화면과 관리 메뉴까지 함께 열립니다).
      </p>
